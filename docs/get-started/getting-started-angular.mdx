...
:::note
You can skip straight to **Step 4** below, as we've already created **My First Realm** for you. But if you want to go through the steps of creating a new realm yourself, follow **Steps 1 thru 3** below.
:::
...
Learn more about the [Authenticator Config](/docs/next/authentication).
