...
:::caution note:
You will need to create a new Application. **My First Application** has been configured specifically for the [**Getting Started with NextJS**](/docs/next/get-started-nextjs) guide
