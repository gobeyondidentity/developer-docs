...
In this step, you'll create a set of Beyond Identity resources containing your end users' identities and the configuration. The default realm and application names are **My First Realm** and **My First Application**, so you can go straight to [**Complete the configuration**](#complete-the-configuration).
