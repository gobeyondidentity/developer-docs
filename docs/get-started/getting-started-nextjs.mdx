...
import ProtocolOIDC from '../includes/notes/protocol_oidc.mdx';
import PKCES256 from '../includes/notes/pkce_s256.mdx';
import ClientTypeConfidential from '../includes/notes/client-type_confidential.mdx';
import GrantTypeAuthorizationCode from '../includes/notes/grant-type_authorization-code.mdx';
import TokenEndpointAuthMethodClientSecretBasic from '../includes/notes/token-endpoint-auth-method_client-secret-basic.mdx';
...
4. Click the **Authenticator Config** tab and select **Hosted Web** as the Configuration Type.
