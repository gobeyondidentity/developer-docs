...
| Authentication Profile (on the **Authenticator Config** tab) | Keep recommended options selected. For more information visit the [authentication guide](docs/next/authentication)                                                                                                                                                                                                                                                                                                       |
| all other options                                        | use the default values for the remaining options                                                                                                                                                                                                                                                                                                                                  |

<br />

docs/next/authentication
