...
If you don't have a Beyond Identity developer account yet, reach out to Beyond Identity Support.
...
<Tabs>
    ...
    <ol>
		<li>Install Git using xcode-select from the terminal.<pre>xcode-select --install</pre></li>
		<li>Download and install <a href="https://nodejs.org/en/download/">NodeJS</a>.<br /><br /></li>
		<li>Install the yarn package manager.<pre>sudo npm install --global yarn</pre></li>
	</ol>
  </TabItem>
    ...
    <ol>
		...
		<li>Download and install <a href="https://nodejs.org/en/download/">NodeJS</a>.<br /><br /></li>
		<li>Install the yarn package manager.<pre>npm install --global yarn</pre></li>
	</ol>
  </TabItem>
</Tabs>
...
2. Edit the **.env.local** file and set the `REGION` value according to your tenant region (`us` or `eu`).
