...
6. Scroll down and set the **Invoke URL** and **Trusted Origins** to the following localhost and port. For more details about these settings, see about [Authenticator Types](/docs/next/authenticator-config).
