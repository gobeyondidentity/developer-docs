...
For a general guide on configuring Roles Based Access Control for your application, see our guide to **[Configure RBAC](/docs/next/configure-rbac)**.
:::
...
To create a new role, follow the steps to [Create a role](docs/next/create-role). Select all scopes that you would like that role to have and give it a proper name and description.

To add identities and groups to that role, follow the steps to [Add a user or group to a role](/docs/next/add-user-group-to-role). Those identities and groups should now have the
