...
<div class="row">
  ...
  <div class="card shadow--lw">
    ...
    <ConfigProvider
            ...
            >
      <Button size="middle" type="primary" shape="round" block href="/docs/create-realm">Learn more</Button>    
      </ConfigProvider>  
    </div>
  </div>
</div>
  ...
  <div class="card shadow--lw">
    ...
    <div class="card__footer">   
      <ConfigProvider
            ...
            >
      <Button size="middle" type="primary" shape="round" block href="/docs/add-an-application">Learn more</Button>    
      </ConfigProvider>
    </div>
  </div>
</div>
  ...
  <div class="card shadow--lw">
    ...
    <div class="card__footer">
      <ConfigProvider
            ...
            >
      <Button size="middle" type="primary" shape="round" block href="/docs/create-role">Learn more</Button>    
      </ConfigProvider>      
    </div>
  </div>
</div>
  ...
  <div class="card shadow--lw">
    ...
    <div class="card__footer">
      <ConfigProvider
            ...
            >
      <Button size="middle" type="primary" shape="round" block href="/docs/add-an-identity">Learn more</Button>    
      </ConfigProvider>
    </div>
  </div>
</div>
