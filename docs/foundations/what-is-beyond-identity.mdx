...
Beyond Identity provides developers flexibility by offering two deployment models and enable ability to add passkey authentication to your existing solution or build solely with Beyond Identity:
Authentication SDKs (Web, iOS, Android) allowing you to customize and craft the authentication journey for your end users.

Hosted Flow to get setup with minimal coding and development required. 

Call to action to the Getting Started or Quick Starts. 
To learn more about passkeys click here (Take user to Passkeys section)
