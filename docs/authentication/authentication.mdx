...
- FIDO2 Multi-Device Passkey - <Badge color="primary" variant="flat" >Coming soon!</Badge>

- Email OTP - <Badge color="primary" variant="flat" >Coming soon!</Badge>

- Federated IDP - <Badge color="primary" variant="flat" >Coming soon!</Badge>
