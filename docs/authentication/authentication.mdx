...
:::danger
There is currently an issue with creating a hosted web authenticator application.

To create a hosted web authenticator application, you can follow this workaround:

1. Create an embedded SDK app
1. Fill in invoke URL and trusted origins with an arbitrary URL
1. Save the application
1. Open the application back up
1. Switch to hosted login and submit again
:::
...
<mark>
  If I understand the documentation correctly, the following are scenarios. If I'm wrong, then we just need to change the column headers and give details and relevance. In other words, "what is it" and "why" should the customer care.
</mark>
...
<mark>
  I think the following can be an _include file as it's also part of the "workflow" (Passkey Binding) and "how-to" (Bind passkeys) topics.
</mark>
