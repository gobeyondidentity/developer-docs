...
* A bootstrap Realm and Application called **My First Realm** and **My First Application**, to be used with our [Getting Started with NextJS](/docs/next/get-started-nextjs) guide.