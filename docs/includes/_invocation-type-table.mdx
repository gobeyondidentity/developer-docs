...
The authentication URL is returned to you as part of a JSON response, but it's up to you to get it to your native/web app any way you see fit. `{"authenticate_url": "$invoke_url/bi-authenticate?request=&#060;request&#062;} ` Since the challenge is packaged as part of the URL, it behaves the same as the **Automatic** Invocation Type. |
