...
- [Kotlin SDK Setup](../sdks/sdk-setup.mdx?sdks=kotlin)

- Before calling [`EmbeddedSdk.authenticate()`](../sdks/sdk-setup.mdx?sdks=kotlin#authentication), you must Authorize with Auth0. 
