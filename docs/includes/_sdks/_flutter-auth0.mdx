...
- Before calling [`EmbeddedSdk.authenticate()`](../sdks/sdk-setup.mdx?sdks=flutter#authentication), you must Authorize with Auth0. 
...
The result will be a URL with the Invoke URL scheme. You can call [`EmbeddedSdk.authenticate()`](../sdks/sdk-setup?sdks=flutter#authentication), using the result. You can confirm the validity of the URL with [`EmbeddedSdk.isAuthenticateUrl()`](../sdks/sdk-setup.mdx?sdks=flutter#authenticate-url-validation).
