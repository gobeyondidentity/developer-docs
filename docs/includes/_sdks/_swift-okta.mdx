...
- [Swift SDK Setup](../sdks/sdk-setup.mdx?sdks=swift)

- Before calling [`Embedded.shared.authenticate`](../sdks/sdk-setup.mdx?sdks=swift#authentication), you must Authorize with Okta. 
