...
- [Kotlin SDK Setup](/sdk-setup?sdks=kotlin)

- Before calling [`EmbeddedSdk.authenticate()`](/sdk-setup?sdks=kotlin#authentication), you must Authorize with Okta. 
