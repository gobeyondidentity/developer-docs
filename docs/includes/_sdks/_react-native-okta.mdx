...
- [React Native SDK Setup](/sdk-setup?sdks=reactnative)

- Before calling [`Embedded.authenticate`](/sdk-setup?sdks=reactnative#authentication), you must Authorize with Okta. 
