...
6. Next, create the HTTP request:
  ...
  **Request url:**
  ...
  This endpoint can also be found in the Console, by navigating to your Application, then to the **External Protocol** tab, and scrolling down until you find the **Token Endpoint**.
