...
1. In the Admin Console, under **Tenant Management**, select **Go to realm > Create new realm**.
  ...
  ![Admin Console Create new realm](../../docs/images/admin-console/go-to-realm-create-new-realm.png)

2. Enter a name for your realm and click **Create realm**.

3. In the confirmation dialog, switch to the new realm. 

  ![Create new realm confirmation success](../../docs/images/admin-console/create-new-realm-confirmation-success.png)
