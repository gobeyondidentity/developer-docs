...
| -------- | ------------- | ------------ |
| Kotlin | 107 KB | 6.6 MB |
| Swift | ? MB | ? MB |

:::note Install Size vs Download Size
Install Size was calculated by importing the SDK into an empty project. This number is larger than Download Size because of other dependencies, and may be much smaller depending on your apps dependencies.
:::
