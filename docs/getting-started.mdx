...
This Getting Started guide shows you how to create and configure your account. You'll connect your account to a demo application that demonstrates common workflows, such as creating a passkey to use for authentication.
...
Before you start, let's ensure you have the standard developer tools installed. The Beyond Identity demo application used in this getting started uses [node.js](https://nodejs.org) for the backend and [NextJS](https://next-auth.js.org/) for the front end. So you'll need everything to get up and running quickly.
