...
description: This Getting Started guide shows you how to create and configure your account. You'll connect your account to a demo application that demonstrates common workflows, such as creating a passkey to use for authentication.
keywords:
  - passkey
  - authentication
  - get started
...
This Getting Started guide shows you how to create and configure your Beyond Identity account. You'll then connect this account to a sample application that demonstrates common workflows, such as creating a passkey (public-private key pairs) to use for authentication.
...
Before you start, let's ensure you have the standard developer tools installed. The Beyond Identity sample application uses [node.js](https://nodejs.org) for the backend and [NextJS](https://next-auth.js.org/) for the front end. So you'll need everything to get up and running quickly.

If you run into any issues or have feedback for us along the way, let us know by **[joining our Slack community](https://join.slack.com/t/byndid/shared_invite/zt-1anns8n83-NQX4JvW7coi9dksADxgeBQ)**.
...
<Tabs>
    ...
    <ol>
		...
		<li>Install the yarn package manager using <code>npm install --global yarn</code> from a bash command line.</li>
	</ol>
  </TabItem>
  <TabItem value="macOS" label="macOS" default>
    <ol>
		<li>Install Git using <code>xcode-select --install</code> from the terminal.</li>
		<li>Download and install <a href="https://nodejs.org/en/download/">NodeJS</a>.</li>
		<li>Install the yarn package manager using <code>sudo npm install --global yarn</code> from the terminal.</li>
	</ol>
  </TabItem>
