...
Before making any API calls you'll want to generate an `accessToken`.
...
Next you'll want to create an identity with the user's information such as an email address and username. Collect this information on your front end and create the identity on your backend. You'll need the `identityId` for the next step.
