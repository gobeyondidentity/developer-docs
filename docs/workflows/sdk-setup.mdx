...
<Tabs groupId="sdks">
<TabItem value="javascript" label="JavaScript" attributes={{className: styles.javascript}}>
...
<TabItem value="kotlin" label="Kotlin" attributes={{className: styles.kotlin}}>
...
<TabItem value="swift" label="Swift" attributes={{className: styles.swift}}>
...
<TabItem value="reactnative" label="React Native" attributes={{className: styles.reactnative}}>
...
<TabItem value="flutter" label="Flutter" attributes={{className: styles.flutter}}>
