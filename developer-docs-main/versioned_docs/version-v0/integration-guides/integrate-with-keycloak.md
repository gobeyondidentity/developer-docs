...
* Access to a Beyond Identity Tenant and a [OIDC client](../getting-started/oidc-configuration.md) configured:
   - `Client ID`
   - `Client Secret`

You can request a tenant [here](../getting-started/create-a-tenant.md) if you do not already have access.
...
![sso-keycloak-9](../images/sso-keycloak-9.png)
