...
### Prerequisites
* Access to a [Beyond Identity tenant](../../getting-started/create-a-tenant.md) 
...
You can follow this guide on how to set the [Registration Redirect URI](../../getting-started/registration-redirect-uri.md) correctly for your tenant. This guide also provides details on how to set the `registration_redirect_uri` when using both the Web and platform/SDK authenticators. 
...
![Credential Inbound](../../images/web-auth-enter-qr.png)
...
![Credential](../../images/web-auth-credential.png)

The 9 digit code will be displayed

![Credential Code](../../images/web-auth-credential-code.png)
