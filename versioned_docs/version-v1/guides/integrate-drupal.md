...
- Access to a Beyond Identity tenant and its admin console. If you don't have one, reach out to Beyond Identity Support.
...
![module-configuration](../images/drupal-oidc-config.png)
